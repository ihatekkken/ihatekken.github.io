...
window.Typekit.config = {
  ...
  "dl": "AAAAZQAAAArAlMJ63-PaITnnvlEAAAAF",
  "f": "//use.typekit.net/c/0c0a7f/1w;adobe-garamond-pro,7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191,Xs1:W:i4;brandon-grotesque,7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191,Y2l:W:n4,Y2q:W:n7/{format}{/extras*}",
  "fc": [{
    "id": 6770,
    "family": "adobe-garamond-pro",
    "src": "{scheme}://{hostname}/af/d7fa29/0000000000000000000130e5/27/{format}{?primer,subset_id,fvd,token}",
    "descriptors": {
      "weight": "400",
      "style": "italic",
    ...
    "src": "{scheme}://{hostname}/af/87035b/0000000000000000000132df/27/{format}{?primer,subset_id,fvd,token}",
    "descriptors": {
      "weight": "400",
      "style": "normal",
      "primer": "7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191"
    ...
    "id": 10296,
    "family": "brandon-grotesque",
    "src": "{scheme}://{hostname}/af/37f12c/0000000000000000000132e3/27/{format}{?primer,subset_id,fvd,token}",
    "descriptors": {
      "weight": "700",
      "style": "normal",
      "primer": "7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191"
  ...
  "fi": [6770, 10294, 10296],
  "fn": ["adobe-garamond-pro", ["i4"], "brandon-grotesque", ["n4", "n7"]],
  "hn": "use.typekit.net",
  "ht": "tk",
  "js": "1.18.8",
  "kt": "jrj6out",
  ...
  "p": "p.typekit.net",
  "ps": 1,
  "token": "2vfklFZtZ0nFinwgOrAW3M+DvuEqVnT+JTdFcMD1KgeKcadzqdxIAIYMTQD/KspsPOgImp/kzkhnKd7UScvEWB0TrAcX+ohzOCLUA1MOw8oHx35CVoBz8c7XIeLEpmxR5fGPsIwynBKrSbZve3XX2hqgnBnkP54in4yLIsKQ7EY=",
  "type": "configurable"
};
/*{"k":"1.18.8","auto_updating":true,"last_published":"2016-08-09 04:09:30 UTC"}*/
;
      ...
      a.fontactive = function (a, b) {
        ...
        a: {
          ...
          for (var l = n.fc, u = 0; u < l.length; u++)
            if (l[u].family === a && l[u].descriptors.weight === h && l[u].descriptors.style === g) {
              g = l[u].id;
              break a
            } g = 0
        }
